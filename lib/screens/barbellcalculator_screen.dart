...
class BarbellCalculatorScreen extends StatefulWidget {
  ...
  @override
  _BarbellCalculatorScreenState createState() => _BarbellCalculatorScreenState();
}
...
class _BarbellCalculatorScreenState extends State<BarbellCalculatorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // title: Text( _barWithPlates ? "${_barWeight}lbs   |   ${(_barWeight * 0.453592).toStringAsFixed(1)}kgs" : title ),
        centerTitle: true,
      ),
  ...
  Widget _plateBox( {required Size size, required String img, required String text} ) {
      ...
      onTap: () {
        ...
        if ( _tempWidth <= 741 ) {
          ...
          Fluttertoast.showToast(
            msg: "Stop! No more space for this",
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Image( image: AssetImage("assets/${img}2.png"), height: size.width * 0.25 ),
